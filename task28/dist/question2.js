...
exports.rotatesArrayBySteps = rotatesArrayBySteps;
function rotatesArrayBySteps(arr, steps) {
    if (steps > arr.length || !Array.isArray(arr) || typeof (steps) !== "number" || steps < 0 || Math.round(steps) !== steps)
        return "Invalid";
