/**Write a function SortByKey(arr, key, order='asc') that sorts an array of objects by
the given key in ascending or descending order.
Example:
Input: [{age:30}, {age:20}], key='age', order='desc'
